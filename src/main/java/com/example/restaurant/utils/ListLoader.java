...
public class ListLoader {
    ...
    private static final String ORDER_ITEM = "src/main/resources/json/orderItem.json";
    ...
    private static List<OrderItem> getOrderItemList() {
        return new Gson().fromJson(Utils.readInput(ORDER_ITEM), new TypeToken<List<OrderItem>>() {
        }.getType());
    }
}
