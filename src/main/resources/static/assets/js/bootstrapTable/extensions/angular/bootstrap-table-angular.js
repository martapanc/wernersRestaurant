...
(function () {
  ...
  angular.module('bsTable', [])
    ...
    var CONTAINER_SELECTOR = '.bootstrapTable';
    ...
    $(document)
      .on('post-header.bs.table', CONTAINER_SELECTOR+' table', function (evt) { // bootstrapTable calls .off('scroll') in initHeader so reattach here
